...
void Data::load()
{
	...
	_sprites[SP_OBSTACLE1].generateFrames(SPRITE_SIZE, SPRITE_SIZE, SP_OBSTACLE1);

	_sprites[SP_OBSTACLE2].frames = OBSTACLE_FRAMES;
	_sprites[SP_OBSTACLE2].sheet = &_sheets[SH_OBSTACLES];
	_sprites[SP_OBSTACLE2].generateFrames(SPRITE_SIZE, SPRITE_SIZE, SP_OBSTACLE2);

	_sprites[SP_OBSTACLE3].frames = OBSTACLE_FRAMES;
	_sprites[SP_OBSTACLE3].sheet = &_sheets[SH_OBSTACLES];
	_sprites[SP_OBSTACLE3].generateFrames(SPRITE_SIZE, SPRITE_SIZE, SP_OBSTACLE3);

	_sprites[SP_OBSTACLE4].frames = OBSTACLE_FRAMES;
	_sprites[SP_OBSTACLE4].sheet = &_sheets[SH_OBSTACLES];
	_sprites[SP_OBSTACLE4].generateFrames(SPRITE_SIZE, SPRITE_SIZE, SP_OBSTACLE4);
	...
	_sprites[SP_GOAT_LEFT].generateFrames(SPRITE_SIZE, SPRITE_SIZE, SP_GOAT_LEFT);
	...
	_sprites[SP_SIGN1].generateFrames(SIGN_WIDTH, SIGN_HEIGHT, SP_SIGN1);

	_sprites[SP_SIGN2].frames = SIGN_FRAMES;
	_sprites[SP_SIGN2].sheet = &_sheets[SH_SIGNS];
	_sprites[SP_SIGN2].generateFrames(SIGN_WIDTH, SIGN_HEIGHT, SP_SIGN2);

	_sprites[SP_SIGN3].frames = SIGN_FRAMES;
	_sprites[SP_SIGN3].sheet = &_sheets[SH_SIGNS];
	_sprites[SP_SIGN3].generateFrames(SIGN_WIDTH, SIGN_HEIGHT, SP_SIGN3);
	...
	_sprites[SP_SIGN4].generateFrames(SIGN_WIDTH, SIGN_HEIGHT, SP_SIGN4);
}
